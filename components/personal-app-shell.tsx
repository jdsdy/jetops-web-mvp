    ...
    >
      ...
      >
        ...
        >
          ...
          <p className="truncate text-xs text-neutral-300">{userDisplayName}</p>
        </div>
      </Link>
...
/**
 * Portal shell with collapsible sidebar navigation for personal app sections.
 */
export function PersonalAppShell({
  ...
  const basePath = getPersonalAppPath();
